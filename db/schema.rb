...
ActiveRecord::Schema.define(version: 2019_08_13_094435) do
  ...
  create_table "upload_arts", force: :cascade do |t|
    t.text "title"
    t.text "description"
    t.date "date"
    t.decimal "start_bid"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["artist_id"], name: "index_upload_arts_on_artist_id"
  end
